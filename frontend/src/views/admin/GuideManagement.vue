...
<template>
  <div class="min-h-screen from-gray-50 to-gray-100 py-6">
    <div class="w-full px-0">
      ...
      <div v-if="filters.category_id && categories.find((c) => c.id == filters.category_id)?.description" class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6 mx-6">
        <div class="flex gap-3">
